package com.example.my27_recyclerview2;
...
public class MainActivity extends AppCompatActivity {
    ...
    * */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 8. 어댑터에 있는 클릭리스너를 호출하여 클릭한 위치의 position을
        // 가져와서 클릭한 위치의 dto를 가져온다
        adapter.setOnItemClickListener(new OnSingeritemClickListener() {
            ...
            public void onItemClick(SingerAdapter.ViewHolder holderm, View view, int position) {
                ...
                Toast.makeText(MainActivity.this, "전화번호 :" + dto.getMobile(), Toast.LENGTH_SHORT).show();
            }
        });
    }
